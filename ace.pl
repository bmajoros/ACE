...
die "
$name <config-file> <reference.multi-fasta> <personal.multi-fasta> <local.gff> <max-VCF-errors> <out.essex>
...
my $ACE=$ENV{"ACE"};
my $refFastaTemp=TempFilename::generate("reffasta");
my $altFastaTemp=TempFilename::generate("altfasta");
my $oneGeneGFF=TempFilename::generate("refgff");
my $aceTemp=TempFilename::generate("ace");
my $gffTemp=TempFilename::generate("altgff");
my $tempRevcomp=TempFilename::generate("revcomp");
